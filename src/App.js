...
const PLATFORMS = {
  uber: {
    ...
    categories: [
      { label: "UberX", seats: 4 },
      { label: "Uber Comfort", seats: 4 },
      { label: "Uber XL", seats: 6 },
      { label: "Uber Van", seats: 7 },
    ],
  },
  bolt: {
    name: "Bolt",
    ...
    stars: 4.8,
    categories: [
      { label: "Bolt Standard", seats: 4 },
      { label: "Bolt XL", seats: 6 },
    ],
  },
  heetch: {
    name: "Heetch",
    ...
    stars: 4.7,
    categories: [
      { label: "Heetch", seats: 4 },
      { label: "Heetch XL", seats: 6 },
    ],
  },
  marcel: {
    name: "Marcel",
    ...
    stars: 4.9,
    categories: [
      { label: "Marcel Berline", seats: 4 },
      { label: "Marcel Van", seats: 7 },
    ],
  },
};
const SCOOTERS = {
...
const PLACES = [
  ...
  { label: "Gare Montparnasse, Paris", lat: 48.841, lng: 2.321 },
  { label: "Gare Saint-Lazare, Paris", lat: 48.8759, lng: 2.3247 },
  { label: "Gare de l'Est, Paris", lat: 48.8767, lng: 2.359 },
  { label: "Tour Eiffel, Paris", lat: 48.8584, lng: 2.2945 },
  { label: "Musée du Louvre, Paris", lat: 48.8606, lng: 2.3376 },
  { label: "Notre-Dame de Paris", lat: 48.853, lng: 2.3499 },
  { label: "Arc de Triomphe, Paris", lat: 48.8738, lng: 2.295 },
  { label: "Sacré-Cœur, Montmartre", lat: 48.8867, lng: 2.3431 },
  { label: "Musée d'Orsay, Paris", lat: 48.86, lng: 2.3266 },
  ...
  { label: "Saint-Germain-des-Prés", lat: 48.854, lng: 2.3337 },
  { label: "Canal Saint-Martin", lat: 48.871, lng: 2.3622 },
  { label: "Pigalle, Paris 9e", lat: 48.8826, lng: 2.3347 },
  { label: "La Défense", lat: 48.8924, lng: 2.238 },
  ...
  { label: "Vincennes", lat: 48.8476, lng: 2.439 },
  ...
  { label: "Parc des Princes, Paris", lat: 48.8414, lng: 2.253 },
  { label: "Accor Arena Bercy, Paris", lat: 48.8383, lng: 2.379 },
  { label: "Disneyland Paris", lat: 48.8722, lng: 2.7759 },
  { label: "Galeries Lafayette, Paris", lat: 48.8739, lng: 2.332 },
...
var MAPBOX_TOKEN =
  "pk.eyJ1IjoiZ290aGFtOTIxIiwiYSI6ImNtcGw4a3JrZzBodHkydHI4dDdzam5nd2UifQ.WIqemPOpVulk335bjShAtQ";
...
var NOTIF_TEMPLATES = [
  {
    ...
    type: "surge",
    icon: "⚡",
    title: "Surge Uber détecté",
    body: "Uber est à x1.8 en ce moment. Bolt reste au prix normal.",
    time: "À l'instant",
    read: false,
  },
  {
    ...
    type: "scooter",
    icon: "🛴",
    title: "Lime disponible près de toi",
    body: "Une trottinette Lime à 85m de ta position. Batterie 78%.",
    time: "Il y a 3 min",
    read: false,
  },
  {
    ...
    type: "saving",
    icon: "💰",
    title: "Tu as économisé 3,20 €",
    body: "En choisissant Bolt plutôt qu'Uber ce matin.",
    time: "Il y a 2h",
    read: true,
  },
  {
    ...
    body: "7 trajets · 34,60 € dépensés · 8,40 € économisés vs Uber.",
    time: "Hier",
    read: true,
  },
];
...
var CGU_TEXT = [
  {
    ...
    content:
      "L'application Mobio est éditée par ⚠️ TON PRÉNOM NOM ⚠️, auto-entrepreneur immatriculé sous le numéro SIRET ⚠️ TON SIRET ⚠️, domicilié à ⚠️ TON ADRESSE ⚠️, France. Contact : contact@mobio.app",
  },
  {
    title: "2. Description du service",
    content:
      "Mobio est une application de comparaison de prix permettant aux utilisateurs de comparer en temps réel les tarifs des plateformes de VTC (Uber, Bolt, Heetch, Marcel) et de micro-mobilité (Lime, Tier, Dott, Vélib'). Mobio n'est pas une plateforme de réservation et n'est affiliée à aucune des plateformes comparées.",
  },
  {
    title: "3. Accès au service",
    content:
      "L'accès à Mobio est gratuit. Certaines fonctionnalités avancées nécessitent un abonnement Pro. L'utilisateur doit être âgé d'au moins 18 ans pour utiliser le service. L'éditeur se réserve le droit de suspendre ou modifier le service à tout moment.",
  },
  {
    title: "4. Responsabilité",
    content:
      "Les prix affichés sur Mobio sont des estimations basées sur les grilles tarifaires publiques des plateformes. Mobio ne garantit pas l'exactitude des prix en temps réel, qui peuvent varier selon les conditions de trafic, la demande et les politiques tarifaires des plateformes. L'éditeur ne saurait être tenu responsable des écarts entre les prix affichés et les prix effectivement facturés par les plateformes.",
  },
  {
    title: "5. Propriété intellectuelle",
    content:
      "L'application Mobio, son design, son code source et ses contenus sont la propriété exclusive de l'éditeur. Toute reproduction, modification ou distribution sans autorisation écrite préalable est interdite.",
  },
  {
    title: "6. Droit applicable",
    content:
      "Les présentes CGU sont soumises au droit français. En cas de litige, les tribunaux français seront seuls compétents. Tout différend sera soumis à une tentative de médiation préalable.",
  },
  {
    title: "7. Modification des CGU",
    content:
      "L'éditeur se réserve le droit de modifier les présentes CGU à tout moment. Les utilisateurs seront informés de toute modification significative par notification dans l'application. La date de dernière mise à jour est indiquée en bas de ce document.",
  },
...
var PRIVACY_TEXT = [
  {
    ...
    content:
      "Le responsable du traitement des données est ⚠️ TON PRÉNOM NOM ⚠️, auto-entrepreneur, domicilié à ⚠️ TON ADRESSE ⚠️, France. Contact DPO : contact@mobio.app",
  },
  {
    title: "2. Données collectées",
    content:
      "Mobio collecte les données suivantes : données de localisation (avec votre consentement), adresses de départ et d'arrivée saisies, adresses favorites enregistrées, historique des trajets consultés, préférences de l'application. Aucune donnée bancaire n'est collectée directement par Mobio.",
  },
  {
    title: "3. Finalités du traitement",
    content:
      "Vos données sont utilisées pour : fournir le service de comparaison de prix, améliorer les recommandations et l'expérience utilisateur, envoyer des notifications (avec votre consentement), établir des statistiques d'usage anonymisées.",
  },
  {
    title: "4. Base légale",
    content:
      "Le traitement de vos données est fondé sur : votre consentement (localisation, notifications), l'exécution du contrat (fourniture du service), l'intérêt légitime (amélioration du service, sécurité).",
  },
  {
    title: "5. Durée de conservation",
    content:
      "Vos données sont conservées pendant toute la durée de votre utilisation de l'application. L'historique des trajets est conservé 12 mois. En cas de suppression du compte, vos données sont effacées sous 30 jours.",
  },
  {
    title: "6. Vos droits (RGPD)",
    content:
      "Conformément au RGPD, vous disposez des droits suivants : droit d'accès à vos données, droit de rectification, droit à l'effacement (droit à l'oubli), droit à la portabilité, droit d'opposition au traitement. Pour exercer ces droits, contactez : contact@mobio.app. Vous pouvez également adresser une réclamation à la CNIL (www.cnil.fr).",
  },
  {
    title: "7. Partage des données",
    content:
      "Mobio ne vend jamais vos données personnelles à des tiers. Vos données peuvent être partagées avec : Mapbox (cartographie, politique de confidentialité sur mapbox.com), les plateformes VTC/mobilité uniquement lors d'un clic de redirection vers leur application.",
  },
  {
    title: "8. Cookies",
    content:
      "Mobio utilise des cookies techniques nécessaires au fonctionnement de l'application et des cookies de mesure d'audience anonymisée. Vous pouvez gérer vos préférences cookies depuis les paramètres de l'application.",
  },
  { title: "Dernière mise à jour", content: "Mai 2025" },
];
...
function getSurge() {
  ...
  var reasons = [];
  if (morningRush || eveningRush) reasons.push("Heure de pointe");
  if (weekendNight) reasons.push("Nuit du weekend");
  if (evening) reasons.push("Soirée");
            ...
            return (
              <div
                ...
                style={{
                  ...
                  cursor: "pointer",
                  borderBottom:
                    i < suggestions.length - 1 ? "1px solid " + T.bsub : "none",
                  display: "flex",
                  alignItems: "center",
                  gap: 8,
                }}
...
function Onboarding(props) {
  ...
  var steps = [
    {
      emoji: "🚗",
      title: "Tous tes transports,\nun seul endroit",
      sub: "Uber, Bolt, Heetch, Lime, Tier…\nCompare tout en quelques secondes.",
      dark: true,
    },
    {
      emoji: "💰",
      title: "Le bon prix,\nau bon moment",
      sub: "Certaines plateformes augmentent leurs prix aux heures de pointe. On te montre qui reste normal.",
      dark: false,
    },
    {
      emoji: "⚡",
      title: "Surge pricing ?\nOn te prévient.",
      sub: "Badge rouge = prix majoré. Badge vert = prix normal. Tu choisis en connaissance de cause.",
      dark: false,
    },
    {
      emoji: "📍",
      title: "Prêt à démarrer",
      sub: "Autorise la localisation pour voir les véhicules autour de toi.",
      dark: false,
    },
  ];
        ...
        {!isLast && (
          <button
            ...
            style={{
              ...
              border: "none",
              fontSize: 13,
              color: isDark ? "rgba(255,255,255,.4)" : "#ccc",
              cursor: "pointer",
              fontWeight: 600,
            }}
          >
      ...
      >
        <div
          style={{
            ...
            height: 80,
            borderRadius: 24,
            background: isDark ? "rgba(255,255,255,.08)" : "#f5f5f5",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            fontSize: 38,
        ...
        {step === 1 && (
          ...
          >
            {[
              ["Bolt", "8,20 €", "#34d186", true],
              ["Heetch", "9,50 €", "#ff1c5b", false],
              ["Uber", "11,40 €", "#000", false],
            ].map(function (item) {
              return (
                <div
                  key={item[0]}
                  style={{
                    ...
                    padding: "6px 10px",
                    marginBottom: 4,
                    border: item[3] ? "1.5px solid #1a1a2e" : "1px solid #eee",
                  }}
                >
                  <div
                    style={{
        ...
        <div
          style={{
            fontSize: 13,
            color: isDark ? "rgba(255,255,255,.55)" : "#888",
            lineHeight: 1.5,
            maxWidth: 280,
            whiteSpace: "pre-line",
          }}
        ...
        {step > 0 && (
          <button
            ...
            style={{
              ...
              color: isDark ? "rgba(255,255,255,.35)" : "#ccc",
              fontSize: 13,
              cursor: "pointer",
              fontFamily: "'DM Sans',sans-serif",
              marginBottom: 6,
...
function Compare(props) {
  ...
  var km = Math.max(0.5, haversine(from.lat, from.lng, to.lat, to.lng) * 1.35);
  ...
  var scList = Object.keys(SCOOTERS).map(function (id, i) {
    ...
    return {
      ...
      unlock: s.unlock,
      pMin: s.pMin,
      price: calcScPrice(id, scMins),
      dist: [85, 140, 210, 320][i],
    };
  });
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", background: T.bg }}>
      ...
      >
        ...
        >
          <div>
            ...
            >
              Tous les transports, un seul endroit
            </div>
          </div>
          <button
      ...
      <div style={{ padding: "12px 16px 0", background: T.card }}>
        ...
        <div
          style={{
            background: flash ? "#e1f5ee" : T.input,
            borderRadius: 10,
            padding: "8px 12px",
            marginBottom: 10,
            display: "flex",
            ...
            border: flash ? "1px solid #34d186" : "1px solid transparent",
          }}
        >
          ...
          {props.favs.map(function (fav) {
            return (
              <div
                ...
                onClick={function () {
                  if (fav.addr) {
                    setTo({ label: fav.addr, lat: fav.lat, lng: fav.lng });
                  } else {
                    props.onFav(fav, "edit");
                  }
                }}
                style={{
                  display: "flex",
                  ...
                  fontSize: 11,
                  fontFamily: "'DM Sans',sans-serif",
                  color: fav.addr ? T.accent : T.muted,
                  fontWeight: fav.addr ? 600 : 400,
                }}
              >
                <span>{fav.icon}</span>
                <span>{fav.addr ? fav.label : "+ " + fav.label}</span>
              </div>
            );
          })}
          <div
            onClick={function () {
              props.onFav(null, "new");
            }}
            style={{
              display: "flex",
              alignItems: "center",
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      cursor: "pointer",
                      fontFamily: "'DM Sans',sans-serif",
                      background: sort === item[0] ? T.accent : T.input,
                      color: sort === item[0] ? "#fff" : T.sub,
                    }}
                  >
                    {item[1]}
                  </button>
            ...
            {vtcList.length === 0 && (
              ...
              >
                ...
                <div style={{ fontSize: 12 }}>
                  Aucune option pour {passengers} passagers. Essaie de réduire
                  le nombre.
                </div>
              </div>
            )}
                  ...
                  {v.surge > 1 && (
                    <div
                      style={{
                        ...
                        top: -9,
                        left: 12,
                        background: v.surge >= 1.8 ? "#c0392b" : "#e67e22",
                        color: "#fff",
                        fontSize: 9,
                        fontWeight: 700,
                        padding: "2px 8px",
                  ...
                  <div style={{ textAlign: "right" }}>
                    ...
                    <div
                      style={{
                        fontSize: 18,
                        fontWeight: 700,
                        color: v.surge >= 1.8 ? "#c0392b" : T.text,
                        fontFamily: "'DM Sans',sans-serif",
                      }}
                    >
                      {v.price.toFixed(2)} €
...
// ── Map Mapbox ─────────────────────────────────────────────────────────────
var MAP_VEHICLES = [
  { id: "uber", kind: "vtc", lat: 48.875, lng: 2.34, color: "#000", eta: 3 },
  {
    id: "bolt",
    kind: "vtc",
    lat: 48.868,
...
function MapView(props) {
  ...
  var VEHICLE_OFFSETS = [
    { id: "uber", kind: "vtc", dlat: 0.008, dlng: 0.01 },
  ...
  function addMarkers(map, currentFilter) {
    ...
    VEHICLE_OFFSETS.filter(function (v) {
      return currentFilter === "tous" || v.kind === currentFilter;
    }).forEach(function (v) {
      var p = PLATFORMS[v.id] || SCOOTERS[v.id];
      var isVtc = v.kind === "vtc";
      var label = isVtc
        ? p.name + " · " + calcVtcPrice(v.id, km, 14).toFixed(2) + " €"
        : v.kind === "scooter"
        ? "🛴 " + p.name
        : "🚲 " + p.name;
  ...
  // 1. Load Mapbox GL JS
  useEffect(function () {
    if (MAPBOX_TOKEN === "COLLE_TON_TOKEN_ICI") {
      setNoToken(true);
      return;
    }
    if (window.mapboxgl) {
    ...
    function () {
      ...
      map.on("load", function () {
        ...
        userEl.style.cssText =
          "width:14px;height:14px;border-radius:50%;background:#34d186;border:3px solid white;box-shadow:0 0 0 8px rgba(52,209,134,.15)";
        var userMarker = new mapboxgl.Marker({ element: userEl })
          .setLngLat([
            props.fromAddr ? props.fromAddr.lng : 2.3553,
            props.fromAddr ? props.fromAddr.lat : 48.8809,
          ])
          .addTo(map);
        ...
        destEl.style.cssText =
          "width:12px;height:12px;border-radius:50%;background:#1a1a2e;border:3px solid white;box-shadow:0 2px 8px rgba(0,0,0,.3)";
        var destMarker = new mapboxgl.Marker({ element: destEl })
          .setLngLat([
            props.toAddr ? props.toAddr.lng : 2.2945,
            props.toAddr ? props.toAddr.lat : 48.8584,
          ])
          .addTo(map);
  ...
  useEffect(
    function () {
      ...
      var ta = props.toAddr || { lat: 48.8584, lng: 2.2945 };
      if (!mapboxRef.current) return;
      drawRoute(mapboxRef.current, fa.lng, fa.lat, ta.lng, ta.lat);
      if (mapboxRef.userMarker)
        mapboxRef.userMarker.setLngLat([fa.lng, fa.lat]);
      if (mapboxRef.destMarker)
        mapboxRef.destMarker.setLngLat([ta.lng, ta.lat]);
  ...
  var selVtc =
    selected && PLATFORMS[selected]
      ? {
          id: selected,
          ...PLATFORMS[selected],
          price: calcVtcPrice(selected, km, 14),
          eta: [3, 4, 6, 8][Object.keys(PLATFORMS).indexOf(selected)],
        }
      : null;
  var selSc =
    selected && SCOOTERS[selected]
      ? { id: selected, ...SCOOTERS[selected] }
      : null;
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {(props.fromAddr || { label: "Gare du Nord" }).label}
          </span>
          <span
            style={{
              flex: 1,
          ...
          >
            {(props.toAddr || { label: "Tour Eiffel" }).label}
          </span>
        </div>
      </div>
      ...
      <div style={{ position: "relative", flex: "0 0 310px" }}>
        ...
        {noToken && (
          ...
          >
            ...
            >
              1. Crée un compte gratuit sur <strong>mapbox.com</strong>
              <br />
          ...
          {filters.map(function (f) {
            return (
              <button
                ...
                style={{
                  background:
                    filter === f[0] ? "#1a1a2e" : "rgba(255,255,255,.95)",
                  color: filter === f[0] ? "#fff" : "#555",
                  border: "none",
                  borderRadius: 20,
                  padding: "5px 12px",
                  fontSize: 11,
            ...
            {selVtc && (
              <div>
                ...
                >
                  ...
                  >
                    {selVtc.price.toFixed(2)} €
                  </div>
                </div>
                <button
                  onClick={function () {
                    props.onVehicle(selVtc);
                    setSelected(null);
                  }}
                  style={{
                    width: "100%",
              ...
              <div>
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      {VEHICLE_OFFSETS.find(function (v) {
      ...
      >
        ...
        >
          ...
          {Object.keys(SCOOTERS)
            .filter(function () {
              return (
                filter === "tous" || filter === "scooter" || filter === "bike"
              );
            })
            .map(function (id) {
              var s = SCOOTERS[id];
...
function Detail(props) {
  ...
  var km = 5.2,
    mins = 14;
  var allPrices = Object.keys(PLATFORMS)
    .map(function (id) {
      return {
        id: id,
        name: PLATFORMS[id].name,
        price: calcVtcPrice(id, km, mins),
      };
    })
    .sort(function (a, b) {
                  ...
                  >
                    <div
                      style={{
                        width: 52,
                        fontSize: 11,
                        fontWeight: p.id === v.id ? 700 : 400,
                        color: p.id === v.id ? T.text : T.sub,
                        fontFamily: "'DM Sans',sans-serif",
                      }}
                    >
                      {p.name}
                    ...
                    >
                      <div
                        style={{
                          width: (p.price / maxP) * 100 + "%",
                          height: "100%",
                          background: p.id === v.id ? v.color : T.muted,
                          borderRadius: 4,
                        }}
                      />
                    </div>
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", background: T.bg }}>
      ...
      >
        ...
        >
          Tous tes trajets en un coup d'œil
        </div>
      </div>
      <div
        style={{
      ...
      >
        {[
          ["47", "Trajets ce mois", "+12%"],
          ["83,40 €", "Dépenses", "−8%"],
          ["34,60 €", "Économies", "grâce à Mobio"],
          ["2,1 kg", "CO2 évité", "vs essence"],
        ].map(function (item) {
          return (
            <div
              key={item[1]}
            ...
            return (
              ...
              >
                ...
                >
                  <div
                    style={{
                      ...
                      background: m.mo === "Mai" ? T.accent : T.border,
                ...
                <div
                  style={{
                    fontSize: 9,
                    color: m.mo === "Mai" ? T.text : T.muted,
                    fontWeight: m.mo === "Mai" ? 700 : 400,
                    fontFamily: "'DM Sans',sans-serif",
                  }}
                >
                  {m.mo}
          ...
          return (
            ...
            >
              ...
              >
                ...
                {h.from}
                <span style={{ color: T.muted }}>→</span>▲{h.to}
              </div>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    padding: "10px 13px",
                    borderBottom:
                      i < arr.length - 1 ? "1px solid " + T.bsub : "none",
                  }}
                >
                  <Logo short={p.short} color={p.color} tc={p.tc} size={30} />
                  <div>
                    ...
                    >
                      {connected.indexOf(id) >= 0 ? "Compte lié" : "Non lié"}
                    </div>
                  </div>
                  <div
                    style={{
                      ...
                      fontFamily: "'DM Sans',sans-serif",
                      background:
                        connected.indexOf(id) >= 0 ? "#e1f5ee" : T.input,
                      color: connected.indexOf(id) >= 0 ? "#085041" : T.sub,
                    }}
                  >
        ...
        >
          {[
            ...
            [
              "🌿",
              "Mode éco",
              "Véhicules électriques en priorité",
              eco,
              function () {
                setEco(!eco);
              },
            ...
            return (
              ...
              >
                ...
                <div style={{ marginLeft: "auto" }}>
                  <Toggle on={item[3]} toggle={item[4]} />
                </div>
              </div>
            );
          })}
        ...
        >
          {[
            ...
            [
              ...
              "contact@mobio.app",
              function () {
                window.location.href = "mailto:contact@mobio.app";
              },
            ],
            ...
            [
              ...
              function () {
                if (navigator.share) {
                  navigator.share({
                    title: "Mobio",
                    text: "Compare tous les VTC en un clin d'œil",
          ...
          >
            <div style={{ padding: "16px 20px 0", flexShrink: 0 }}>
              ...
              {(legalModal === "cgu" || legalModal === "privacy") && (
                ...
                >
                  ⚠️ Remplace les zones marquées ⚠️ par tes vraies informations
                ...
                : [
                    {
                      ...
                      content:
                        "Ces cookies sont indispensables au fonctionnement de l'application. Ils ne peuvent pas être désactivés.",
                    },
                    {
                      title: "Cookies analytiques",
                      content:
                        "Ces cookies nous permettent de mesurer l'audience de l'application de façon anonyme. Vous pouvez les désactiver ci-dessous.",
                    },
                    {
                      title: "Vos choix",
                      content:
                        "Vous pouvez modifier vos préférences à tout moment depuis cette page. Le refus des cookies analytiques n'affecte pas votre utilisation de Mobio.",
                    },
                  ]
          ...
          >
            ...
            <div style={{ textAlign: "center", marginBottom: 20 }}>
              <img
                src={ENHAX_LOGO}
                alt="Enhax"
                style={{ height: 36, marginBottom: 10, opacity: 0.85 }}
              />
...
function FavModal(props) {
  ...
  var [sel, setSel] = useState(
    fav && fav.addr ? { label: fav.addr, lat: fav.lat, lng: fav.lng } : null
  );
  var ICONS = [
    "📍",
    "⭐",
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: 10,
                      cursor: "pointer",
                      background: ico === e ? T.accent : T.input,
                      border:
                        ico === e
                          ? "2px solid " + T.accent
                          : "2px solid transparent",
        ...
        <button
          onClick={function () {
            if (sel) {
              props.onSave(
                sel,
                isDef ? null : { label: lbl || "Favori", icon: ico }
              );
              props.onClose();
            }
          }}
  ...
  function triggerToast() {
    ...
    if (unread.length > 0) {
      ...
      var demo = {
        id: 99,
        icon: "⚡",
        title: "Test — Surge Uber détecté",
        body: "Uber est à x1.8. Bolt reste au prix normal.",
        time: "À l'instant",
        read: false,
      };
      setToast(demo);
